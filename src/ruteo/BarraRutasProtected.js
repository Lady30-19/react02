...
import Docupdf from '../protegido/sistemafile/Docupdf.js';
import ListaDeEgresados from '../protegido/sistemacrud/ListaDeEgresados.js';
      ...
      <div>
        <nav>
          ...
          <div id="menu">
            <ul>
              ...
              <li><Link to="/sistema-file/docupdf">Doc. PDF</Link> </li>
        ...
        <Routes>
          ...
          <Route path="/sistema-file" element={<MarcoParaSistemaFILE />}>
            ...
            <Route path="docupdf" element={<Docupdf />} />
